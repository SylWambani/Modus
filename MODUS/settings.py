"""
Django settings for MODUS project.
...
SECRET_KEY = 'django-insecure-02q5n^31qyvdivrs@h4t=58x+d5i+lhph*ppboct%_bugg9$!h'
...
WSGI_APPLICATION = 'MODUS.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'procurement.permissions.CustomDjangoModelPermissions',
    ),
